...
import { fetchLongTermMetrics, type LongTermMetrics } from "../api/snowflake.ts";
    ...
    >
      ...
      {!loading && !err && data && (
        <div className="grid grid-cols-1 gap-4">
          ...
          {/* Card 2: Average risk vs hour-of-shift */}
          <div className="card h-[36vh]">
